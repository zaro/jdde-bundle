...
import com.pretty_tools.dde.NativeLibInJarHelper;
...
public abstract class DDEServer
{
    ...
    static// Loads the library, if available.
    {
        if ("64".equals(System.getProperty("sun.arch.data.model")))
        	NativeLibInJarHelper.loadLibrary("JavaDDEx64", "com/pretty_tools/dde/");
        else
        	NativeLibInJarHelper.loadLibrary("JavaDDE", "com/pretty_tools/dde/");
    }
}
